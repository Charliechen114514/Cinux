...
- [System V Application Binary Interface AMD64](https://refspecs.linuxbase.org/elf/x86_64-abi-0.99.pdf) — x86_64 SysV ABI 栈对齐要求：`call` 前 RSP 必须是 16 的倍数（第 3.2.2 节 "The Stack Frame"）
