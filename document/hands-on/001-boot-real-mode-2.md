...
- Intel SDM: Vol.3A §10.1.1 — Processor State After Reset, A20 gate 行为
- Intel SDM: Vol.3A §21.1.1 — Real-Address Mode 段:偏移寻址
- OSDev Wiki: [A20 Line](https://wiki.osdev.org/A20_Line) — A20 历史、开启方式（BIOS/Fast A20/8042）
- OSDev Wiki: [VESA Video Modes](https://wiki.osdev.org/VESA_Video_Modes) — VBE 调用流程、VbeInfoBlock/ModeInfoBlock 字段定义、模式设置标志
- OSDev Wiki: [MBR (x86)](https://wiki.osdev.org/MBR_(x86)) — MBR 格式和内存布局参考
