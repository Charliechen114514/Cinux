...
void gui_start() {
    ...
    // Create test windows for verification
    WindowManager::instance().create("Window 1", 320, 200);
    WindowManager::instance().create("Window 2", 280, 180);
    WindowManager::instance().create("Window 3", 250, 160);

    cinux::lib::kprintf("[GUI] WindowManager initialised with %u test windows.\n",
                        WindowManager::instance().window_count());
